...
public class ModelComparer {
    private static MultiLayerNetwork model1;
    private static MultiLayerNetwork model2;
    ...
    private static Label lblResult1;
    private static Label lblResult2;

    //to load model after creating
    public static void loadModel1(File modelLocation) throws IOException {
        model1 = MultiLayerNetwork.load(modelLocation, true);
        ModelTester.setModel(model1);
    }

    public static void loadModel2(File modelLocation) throws IOException {
    ...
    public static void recognizedigit(Stage primaryStage) {
        ...
        lblResult1.getStyleClass().add("result");
        lblResult2.getStyleClass().add("result");
        ...
        //body
        VBox body = new VBox(5, hbBottom, lblResult1, lblResult2);
        ...
        options.getItems().addAll(currentModel, probability);
